      ...
      <header className="sticky top-0 left-0 right-0 z-50 backdrop-blur-md bg-slate-950/70 border-b border-white/5">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center space-x-1">
            <button onClick={() => scrollToSection('problem')} className="text-slate-300 hover:text-white hover:bg-white/5 px-4 py-2.5 rounded-lg transition-all text-sm font-medium">Why STABILIQ</button>
